    ...
    fn read_property(
        ...
        match property_id {
            ...
            PropertyIdentifier::NumberOfStates => {
                Ok(PropertyValue::Unsigned(self.number_of_states))
            }
    ...
    fn all_properties(&self) -> Vec<(PropertyIdentifier, PropertyValue)> {
        vec![
            ...
            (
                ...
                PropertyValue::Enumerated(ObjectType::MultiStateInput as u32),
            ),
            (
                PropertyIdentifier::Description,
            ...
            (
                ...
                PropertyValue::Unsigned(self.present_value),
            ),
            (
                PropertyIdentifier::NumberOfStates,
                PropertyValue::Unsigned(self.number_of_states),
            ),
            (
